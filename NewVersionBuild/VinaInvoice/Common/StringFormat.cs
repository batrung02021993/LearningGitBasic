    ...
    public static class StringFormat
    {
        ...
        public static string NumberToWords(Int64 number)
        {
            ...
            if (number > 0)
            {
                ...
                var unitsMap1 = new[] { "không", "một", "hai", "ba", "bốn", "lăm", "sáu", "bảy", "tám", "chín" };
        ...
        private static string Tach(string tach3)
        {
            ...
            if (tach3.Length == 3)
            {
                ...
                if (tr.Equals("0") && Convert.ToInt32(ch) > 1 && dv.Equals("1"))
                    Ktach = " không trăm " + Chu(ch.Trim()).Trim() + " mươi mốt ";
                ...
                if (Convert.ToInt32(tr) > 0 && Convert.ToInt32(ch) > 1 && dv.Equals("1"))
                    Ktach = Chu(tr.Trim()).Trim() + " trăm " + Chu(ch.Trim()).Trim() + " mươi mốt ";
                if (Convert.ToInt32(tr) > 0 && Convert.ToInt32(ch) == 1 && dv.Equals("1"))
                    Ktach = Chu(tr.Trim()).Trim() + " trăm " + Chu(ch.Trim()).Trim() + " mười một ";
